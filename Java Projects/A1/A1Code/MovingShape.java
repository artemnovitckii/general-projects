...
public abstract class MovingShape {
	...
	/*
     *  ===============================================================================
     *  ArrowRightPath : A path which moves shapes from left to right.
     *  ===============================================================================
     */
	public class ArrowRightPath extends MovingPath {
		private double am = 0, sty =0, sinDeltaY = 0;
		
		//constructor to initialise values for a arrow right path
        public ArrowRightPath() {
            am = Math.random() * 20; //set amplitude variables
            sty = 0.5; //set step variables on y axis
            deltaX = 5; //how fast it travels the distance
            sinDeltaY = 0; //the starting position 
       }
       ...
       public void move() {
           ...
           topLeft.x = topLeft.x + deltaX;
           if (topLeft.x > marginWidth) // if it reaches the right side of the frame, start again from the the left
               topLeft.x = 0;
       }
