...
public class AnimationPanel extends JComponent implements Runnable {
    ...
    protected void createNewShape(int x, int y) {
        ...
        switch (currentShapeType) {
			...
			case 2:{
				shapes.add(new MovingSquare(x, y, Math.min(currentWidth,currentHeight),Math.min(currentWidth,currentHeight),marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath));
				break;
			}
			
			case 3:{
				shapes.add(new MovingSquarePattern(x, y, Math.min(currentWidth,currentHeight),Math.min(currentWidth,currentHeight),marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath));
				break;
			}
			
			case 4:{
				shapes.add(new MovingQuadPie(x, y, Math.min(currentWidth,currentHeight),Math.min(currentWidth,currentHeight),marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath));
				break;
			}
		}
	}
